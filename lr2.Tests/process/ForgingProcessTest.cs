...
[TestClass]
[TestSubject(typeof(ForgingProcess))]
public class ForgingProcessTest
{

    [TestMethod]
    public void GetNewDetail_test()
    {
        ForgingProcess process = new ForgingProcess(WorkerType.Stamper, 1);
        ...
        Assert.AreEqual(detail.GetDetailType(), DetailType.Сhassis);
